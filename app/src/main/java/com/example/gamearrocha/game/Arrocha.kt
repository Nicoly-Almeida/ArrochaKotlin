package com.example.gamearrocha.game;
import kotlin.random.Random.Default.nextInt;

public class Arrocha(var limiteInferior: Int, var limiteSuperior: Int, var numeroSorteado: Int = nextInt(limiteInferior, limiteSuperior)){
    var contador: Int = 0
